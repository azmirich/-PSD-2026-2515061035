...
if pilih == 1: untuk memasukkan daftar kamar kos yang tersedia
elif pilih == 2: mencari kamar kos yang tersedia
elif pilih == 3: menampilkan list kamar kos yang tersedia dalam INORDER
elif pilih == 4: menampilkan list kamar kos yang tersedia dalam PREORDER
elif pilih == 5: menampilkan list kamar kos yang tersedia dalam POSTORDER
elif pilih == 6: menampilkan hasil dari fungsi count untuk menghitung total kamar kos
elif pilih == 7: menunjukkan program selesai dan keluar dari program
